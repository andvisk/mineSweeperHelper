...
public class ProcessingServiceTest {
        ...
        @Test
        void runTestImage5() {
                runTest("src/test/resources/src5.png", getBoardNumbersForImage5());
        }
        @Test
        void runTestImage3() {
                runTest("src/test/resources/src3.png", getBoardNumbersForImage3());
        }
        @Test
        void runTestImage1() {
                runTest("src/test/resources/src1.png", getBoardNumbersForImage1());
        }

        void runTest(String fileName, int[][] expectedNumbers) {

                System.loadLibrary(Core.NATIVE_LIBRARY_NAME);

                Mat screenShot = Imgcodecs.imread(fileName);
                ...
                Imgcodecs.imwrite(
                                ProcessingService.debugDir + File.separatorChar + "debug_"
                                                + FilenameUtils.removeExtension(new File(fileName).getName()) + ".png",
                                finalResult);
        ...
        private int[][] getBoardNumbersForImage5() {
        ...
        private int[][] getBoardNumbersForImage3() {
        ...
        private int[][] getBoardNumbersForImage1() {
                int[][] data = new int[30][16];
                data[0][0] = 0;
                data[1][0] = 0;
                data[2][0] = 0;
